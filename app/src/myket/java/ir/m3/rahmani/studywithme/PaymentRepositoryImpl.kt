...
//                        result.invoke(Result.success(purchase.convertToMyPurchase()))   // None consumable
    ...
    companion object {
        const val MYKET_PUBLIC_KEY =
            "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCc3K32ILOGwrz0LUG4aErGN5ptj1vaJjeZI+0lsT7vd9pApxRpAa1rAdwb25joFGwxZS12Q2t/8GZpqg5eCSJuGj+tz0wN8pN6I+6MquhhNfC7hjKCtkgs+nbuJvxfSLIoCWigORNsHvQT610YS3mEkXag9gVyKWx+h1LhUsCCvQIDAQAB"
    }
}
