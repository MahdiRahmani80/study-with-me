...
public final class DaggerAppComponent {
  ...
  private static final class AppComponentImpl implements AppComponent {
    ...
    private void initialize(final ApiServiceModule apiServiceModuleParam,
      ...
      this.homeViewModelProvider = DoubleCheck.provider(HomeViewModel_Factory.create(userSharedPreferenceRepositoryProvider, challengeRepositoryProvider, playLocalRepositoryProvider, pomodoroViewModelProvider));
