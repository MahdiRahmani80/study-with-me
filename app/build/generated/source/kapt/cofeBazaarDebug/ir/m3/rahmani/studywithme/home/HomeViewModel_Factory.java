...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel get() {
    HomeViewModel instance = newInstance(userSharedPrefProvider.get(), challengeRepositoryProvider.get(), playLocalRepositoryProvider.get());
  ...
  public static HomeViewModel_Factory create(
      ...
      Provider<PlayLocalRepository> playLocalRepositoryProvider,
      Provider<PomodoroViewModel> pomodoroViewModelProvider) {
    return new HomeViewModel_Factory(userSharedPrefProvider, challengeRepositoryProvider, playLocalRepositoryProvider, pomodoroViewModelProvider);
  }
  ...
  public static HomeViewModel newInstance(UserSharedPreferenceRepository userSharedPref,
    ...
    return new HomeViewModel(userSharedPref, challengeRepository, playLocalRepository);
  }
}
